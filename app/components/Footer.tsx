    ...
    return (
        <footer className="py-6 bg-black border-t border-gray-800 text-center text-zinc-600 text-sm">
            <div className="flex justify-center space-x-4 mb-2">
                <a href="https://www.youtube.com/@hottakerecordingco9302" target="_blank" rel="noreferrer noopener" aria-label="YouTube">
                ...
                <a href="https://www.facebook.com/HotTakeRecordingCo/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/hottakerecordingco/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
